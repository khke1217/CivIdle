export const KR = {
   ...
   Charlemagne: "카롤루스 대제",
   CharlesDarwin: "찰스 다윈",
   CharlesDarwinDesc: "+%{value} 노동중인 일꾼당 과학 생산",
   ...
   ForbiddenCity: "자금성",
   ForbiddenCityDesc: "모든 제지소, 인쇄소, 작가길드가 +1의 생산, 저장소, 일꾼 용량배수를 얻습니다",
   Forex: "외환",
   ForexMarket: "외환 시장",
   ...
   LumberMill: "제재소",
   LuxorTemple: "룩소르 신전",
   LuxorTempleDesc: "+1 노동중인 일꾼당 과학 생산",
   Machinery: "기계",
   Magazine: "잡지",
   ...
   RijksmuseumDesc: "행복도 +5, 문화를 소비하거나 생산하는 모든 건물이 +1의 생산, 저장소, 일꾼 용량배수를 얻습니다.",
   RoadAndWheel: "도로와 바퀴",
   ...
   Socrates: "소크라테스",
   SocratesDesc: "+%{value} 노동중인 일꾼당 과학 생산",
   Sound: "소리",
   SoundEffect: "효과음",
   ...
   SummerPalace: "이화원",
   SummerPalaceDesc: "화약을 생산하거나 소비하는 모든 인접한 건물은 행복도 -1이 면제되며, 화약을 소비하거나 생산하는 모든 건물이 +1의 생산, 저장소, 일꾼 용량배수를 얻습니다.",
   Sword: "검",
   SwordForge: "검 대장간",
   ...
   TangOfShang: "탕왕",
   TangOfShangDesc: "+%{value} 쉬고 있는 일꾼당 과학 생산",
   Tank: "탱크",
   TankFactory: "탱크 공장",
   TechAge: "Age",
   ...
   TempleOfArtemisDesc: "완성시 모든 검 대장간과 무기고가 +5레벨을 얻습니다. 모든 검 대장간과 무기고가 +1의 생산, 저장소, 일꾼 용량배수를 얻습니다.",
   TempleOfHeaven: "천단",
   ...
   WorkersRequiredBeforeMultiplier: "필요한 일꾼 용량",
   WorkersRequiredForProductionMultiplier: "일꾼 당 생산능력",
   WorkersRequiredForTransportationMultiplier: "일꾼당 운송용량",
