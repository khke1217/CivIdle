export const KR = {
   ...
   AlanTuring: "앨런 튜링",
   AlanTuringDesc: "쉬고 있는 일꾼 당 +%{value} 과학 생산",
   ...
   AngkorWat: "앙코르 와트",
   AngkorWatDesc: "모든 인접한 건물이 +1의 일꾼 당 생산능력 배수를 얻습니다. 1000 일꾼을 생산합니다.",
   ...
   ApolloProgramDesc: "모든 로켓 공장은 생산, 일꾼 당 생산능력, 저장 배수 +2를 얻습니다. 위성 공장, 우주선 공장, 핵 미사일 사일로는 인접한 로켓 공장마다 생산 배수 +1을 얻습니다.",
   ApplyToAll: "일괄 적용",
   ...
   BrandenburgGateDesc: "모든 석탄광산과 유정이 +1의 생산, 저장소, 일꾼 당 생산능력 배수를 얻습니다. 정유 공장이 인접한 석유 타일 하나당 +1의 생산, 저장소, 일꾼 당 생산능력 배수를 얻습니다.",
   Bread: "빵",
   Brewery: "양조장",
   Brick: "벽돌",
   Brickworks: "벽돌 공장",
   ...
   BuildingName: "이름",
   BuildingNoMultiplier: "%{building}은 생산, 일꾼 당 생산능력, 저장 등의 배수에 <b>영향을 받지 않습니다</b>.",
   ...
   CarlFriedrichGaussDesc: "쉬고 있는 일꾼 당 과학 생산 +%{idle}. 노동중인 일꾼 당 과학 생산 +%{busy}",
   Cathedral: "대성당",
   Census: "인구조사",
   ...
   Charlemagne: "카롤루스 대제",
   CharlesDarwin: "찰스 다윈",
   CharlesDarwinDesc: "+%{value} 노동중인 일꾼 당 과학 생산",
   ...
   ChichenItza: "치첸 이트사",
   ChichenItzaDesc: "모든 인접한 건물이 +1의 생산, 저장소, 일꾼 당 생산능력 배수를 얻습니다.",
   ...
   CNTower: "CN 타워",
   CNTowerDesc: "모든 영화 스튜디오, 라디오 방송국 및 TV 방송국은 -1 행복도에서 면제됩니다. 세계 대전과 냉전에서 잠금 해제된 모든 건물은 +N 생산, 일꾼 수용력 및 저장 배수를 얻습니다. N = 건물의 티어와 시대의 차이",
   Coal: "석탄",
   CoalMine: "석탄 광산",
   ...
   Colonialism: "식민주의",
   Colosseum: "콜로세움",
   ColosseumDesc: "전차공장은 행복도 -1이 면제 되며, 전차10대를 소모하여 행복도를 10 생산합니다.",
   ColossusOfRhodes: "로도스의 거상",
   ColossusOfRhodesDesc: "일꾼을 생산하지 않는 모든 인접한 건물이 +1의 행복도를 얻습니다.",
   Combustion: "연소",
   Computer: "컴퓨터",
   ...
   ConfirmYes: "예",
   Confucius: "공자",
   ConfuciusDescV2: "50% 이상의 일꾼이 노동중이고 노동중인 근로자의 50% 미만이 운송 분야에 근무하는 경우 모든 일꾼의 과학 생산 +%{value}",
   Constitution: "헌법",
   Construction: "건축",
   ...
   ContentInDevelopmentDesc: "이 게임 콘텐츠는 아직 개발중이며 향후 게임 업데이트에서 사용할수 있습니다. 지켜봐주세요!",
   Copper: "구리",
   ...
   Education: "교육",
   EiffelTower: "에펠탑",
   EiffelTowerDesc: "모든 인접한 제강공장이 +N 의 생산, 저장소, 일꾼 당 생산능력 배수를 얻습니다. N = 인접한 제강공장의 수",
   Electricity: "전력",
   Electrification: "전기화",
   ...
   ElectrificationUpgrade: "전기화 해금. 건물이 전력을 소모하여 생산을 늘릴수 있습니다.",
   Electrolysis: "전기분해",
   ...
   Feudalism: "봉건제",
   Fibonacci: "피보나치",
   FibonacciDescV2: "쉬고 있는 일꾼 과학 생산 +%{idle}. 노동중인 일꾼 과학 생산 +%{busy}. 피보나치의 영구 업그레이드 비용은 피보나치 수열을 따릅니다.",
   FighterJet: "전투기",
   ...
   ForbiddenCity: "자금성",
   ForbiddenCityDesc: "모든 제지소, 인쇄소, 작가길드가 +1의 생산, 저장소, 일꾼 당 생산능력 배수를 얻습니다",
   Forex: "외환",
   ForexMarket: "외환 시장",
   ...
   GalileoGalileiDesc: "쉬고 있는 일꾼 과학 생산 +%{value}",
   Galleon: "갤리온",
   ...
   GreatMosqueOfSamarraDescV2: "건물 시야 범위 +1. 탐험되지 않은 무작위 광상 타일 5개를 공개하고 각 타일에 레벨 10 자원 추출 건물이 건설됩니다.",
   GreatPeople: "위인",
   ...
   GreatWall: "만리장성",
   GreatWallDesc: "1 타일 범위 내의 모든 건물은 +N 생산, 일꾼 수용력 및 저장 승수를 얻습니다. N = 현재 시대와 건물이 처음 잠금 해제된 시대 사이의 시대 수입니다. 자금성 옆에 건설하면 범위가 2타일로 늘어납니다.",
   GrottaAzzurra: "카프리 푸른 동굴",
   GrottaAzzurraDesc: "발견되면, 현재 보유중인 모든 티어1 건물이 +5 레벨을 얻습니다.",
   Gunpowder: "화약",
   GunpowderMill: "화약 공장",
   HagiaSophia: "하기아 소피아",
   HagiaSophiaDesc: "생산능력이 0%인 건물은 행복도-1이 면제됩니다. 믿음10을 소비하여 행복도를 10 생산합니다.",
   HallOfSupremeHarmony: "태화전",
   Hammurabi: "함무라비",
   HangingGarden: "바빌론의 공중정원",
   HangingGardenDesc: "+1 일꾼 당 생산능력 배수. 인접한 수로가 +1의 생산, 저장소, 일꾼 당 생산능력 배수를 얻습니다.",
   Happiness: "행복도",
   ...
   HatshepsutTempleDesc: "건설완료시 지도상의 모든 물 타일을 밝힙니다. 밀 농장이 인접한 물 타일 하나당 +1의 생산 배수를 얻습니다.",
   Headquarter: "본부",
   HelpMenu: "지원",
   HenryFord: "헨리 포드",
   Herding: "목축",
   Herodotus: "헤로도토스",
   HimejiCastle: "히메지 성",
   HimejiCastleDesc: "모든 캐러벨 조선소, 갤리온 조선소, 프리깃 조선소가 +1의 생산, 저장소, 일꾼 당 생산능력 배수를 얻습니다.",
   Hollywood: "할리우드",
   ...
   IronTech: "철",
   IsaacNewton: "아이작 뉴턴",
   IsaacNewtonDescV2: "50% 이상의 일꾼이 노동중이고 노동중인 일꾼의 50% 미만이 운송 분야에 근무하는 경우 모든 일꾼의 과학 생산 +%{value}",
   ...
   JamesWatson: "제임스 왓슨",
   JamesWatsonDesc: "노동중인 일꾼 당 과학 생산 +%{value}",
   JamesWatt: "제임스 와트",
   JetPropulsion: "제트 추진",
   ...
   JohnVonNeumannDesc: "노동중인 일꾼의 과학 생산 +%{value}",
   ...
   LinusPaulingDesc: "쉬고 있는 일꾼 당 과학 생산 +%{value}",
   Literature: "문학",
   LivestockFarm: "외양간",
   ...
   LumberMill: "제재소",
   LuxorTemple: "룩소르 신전",
   LuxorTempleDesc: "+1 노동중인 일꾼 당 과학 생산",
   Machinery: "기계",
   Magazine: "잡지",
   ...
   MausoleumAtHalicarnassusDesc: "영묘료부터 2타일 내에서는 운송에 일꾼이 필요하지 않습니다.",
   MaxExplorers: "최대 탐험가",
   ...
   MoaiDesc: "모아이 석상",
   MogaoCaves: "막고굴",
   MogaoCavesDescV2: "노동중인 일꾼 10%마다 행복도가 1 증가합니다. 인접한 모든 성소는 행복도 -1에서 면제됩니다.",
   ...
   NielsBohr: "닐스 보어",
   NielsBohrDescV2: "50% 이상의 일꾼이 노동중이고 노동중인 일꾼의 50% 미만이 운송 분야에 근무하는 경우 모든 일꾼의 과학 생산 +%{value} ",
   NileRiver: "나일 강",
   ...
   Parliament: "국회",
   Parthenon: "파르테논 신전",
   ParthenonDescV2: "고전 시대의 위인 둘이 태어나고 각각 4개의 선택권을 얻습니다. 음악가 길드와 화가 길드가 +1 생산력, 일꾼 당 생산능력, 저장 배수를 얻고 -1 행복도에서 면제됩니다.",
   PatchNotes: "패치노트",
   PermanentGreatPeople: "영구적인 위인",
   PermanentGreatPeopleAcquired: "영구적인 위인 획득",
   PermanentGreatPeopleLevels: "영구적인 위인 레벨",
   Persepolis: "페르세폴리스",
   PersepolisDesc: "모든 벌목장, 채석장, 구리광산이 +1의 생산, 저장소, 일꾼 당 생산능력 배수를 얻습니다.",
   Petra: "페트라",
   ...
   PyramidOfGizaDesc: "일꾼을 생산하는 모든 건물이 +1의 생산배수를 얻습니다.",
   QinShiHuang: "진시황제",
   Radio: "라디오",
   ...
   RequiredWorkersTooltip: "생산에 필요한 일꾼 수는 배수 계산 후 소비 및 생산되는 모든 자원의 합계와 같습니다(전력화 제외).",
   RequirePower: "전력 필요함",
   ...
   RichardFeynmanDesc: "50% 이상의 일꾼이 노동중이고 노동중인 일꾼의 50% 미만이 운송 분야에 근무하는 경우 모든 일꾼의 과학 생산 +%{value}",
   RichardJordanGatling: "리처드 조던 개틀링",
   Rifle: "라이플",
   RifleFactory: "라이플 공장",
   Rifling: "강선",
   Rijksmuseum: "암스테르담 국립미술관",
   RijksmuseumDesc: "행복도 +5, 문화를 소비하거나 생산하는 모든 건물이 +1의 생산, 저장소, 일꾼 당 생산능력 배수를 얻습니다.",
   RoadAndWheel: "도로와 바퀴",
   ...
   SaintBasilsCathedralDescV2: "자원 추출 건물이 광상 근처에서 작동하도록 허용합니다. 모든 티어 1 건물은 생산 승수, 일꾼 수용 능력 승수, 저장 배수 +1을 얻습니다.",
   Saladin: "살라딘",
   Sand: "모래",
   Sandpit: "모래 채취장",
   ...
   School: "학교",
   Science: "과학",
   ScienceFromBusyWorkers: "노동중인 일꾼 과학 생산",
   ScienceFromIdleWorkers: "쉬고 있는 일꾼 과학 생산",
   SciencePerBusyWorker: "노동중인 일꾼 당",
   SciencePerIdleWorker: "쉬고 있는 일꾼 당",
   ...
   Socrates: "소크라테스",
   SocratesDesc: "+%{value} 노동중인 일꾼 당 과학 생산",
   Sound: "소리",
   SoundEffect: "효과음",
   ...
   SpaceNeedle: "스페이스 니들",
   SpaceNeedleDesc: "건설된 불가사의 하나당 행복도 +1",
   SpaceProgram: "우주 계획",
   Sports: "스포츠",
   Stable: "마구간",
   Stadium: "경기장",
   ...
   StatisticsScienceFromWorkers: "일꾼이 제공하는 과학",
   ...
   StatisticsTransportationPercentage: "운송중인 일꾼 비율",
   StatueOfLiberty: "자유의 여신상",
   StatueOfLibertyDesc: "모든 인접한 건물이 +N의 생산, 저장소, 일꾼 당 생산능력 배수를 얻습니다. N = 동일한 유형의 인접한 건물 수",
   StatueOfZeus: "제우스 상",
   ...
   SummerPalace: "이화원",
   SummerPalaceDesc: "화약을 생산하거나 소비하는 모든 인접한 건물은 행복도 -1이 면제되며, 화약을 소비하거나 생산하는 모든 건물이 +1의 생산, 저장소, 일꾼 당 생산능력 배수를 얻습니다.",
   Sword: "검",
   SwordForge: "검 대장간",
   ...
   Synthetics: "합성화학",
   TajMahal: "타지마할",
   TajMahalDescV2: "고전시대의 위인과 중세시대의 위인이 탄생합니다. 레벨 20 이상의 건물을 업그레이드할 때 건축가 수용력 승수 +5",
   TangOfShang: "탕왕",
   TangOfShangDesc: "+%{value} 쉬고 있는 일꾼 당 과학 생산",
   Tank: "탱크",
   TankFactory: "탱크 공장",
   TechAge: "Age",
   ...
   TechResourceTransportPreferenceAmountTooltip: "이 건물은 저장 공간에 더 많은 자원을 가진 건물에서 자원을 운반하는 것을 선호합니다.",
   TechResourceTransportPreferenceDefault: "기본",
   TechResourceTransportPreferenceDefaultTooltip: "이 자원에 대한 교통 기본 설정을 재정의하지 말고 대신 건물의 교통 기본 설정을 사용합니다.",
   ...
   TechResourceTransportPreferenceStorageTooltip: "이 건물은 사용된 저장 공간의 비율이 더 높은 건물에서 자원을 운반하는 것을 선호합니다.",
   TechStockpileMode: "비축 모드 잠금 해제 - 건물별로 비축량을 조정할수 있습니다.",
   Television: "텔레비전",
   TempleOfArtemis: "아르테미스 신전",
   TempleOfArtemisDesc: "완성시 모든 검 대장간과 무기고가 +5레벨을 얻습니다. 모든 검 대장간과 무기고가 +1의 생산, 저장소, 일꾼 당 생산능력 배수를 얻습니다.",
   TempleOfHeaven: "천단",
   TempleOfHeavenDesc: "레벨 10이상의 모든 건물이 +1의 일꾼 당 생산능력 배수를 얻습니다.",
   TempleOfPtah: "프타 사원",
   TerracottaArmy: "병마용",
   TerracottaArmyDesc: "모든 철 광산이 +1의 생산, 저장소, 일꾼 당 생산능력 배수를 얻습니다. 철 대장간이 인접한 철 광산 하나당 +1의 생산 배수를 얻습니다.",
   Theater: "극장",
   Theme: "테마",
   ThemeColor: "테마 색상",
   ...
   Tutorial4:
      "건물은 제국의 기본 구성요소입니다. - 밝혀진 타일에 건물을 배치하세요. 수로나 채석장등 자원을 추출하는 건물은 자원 매장층 위에 건설해야합니다. 건물은 주변 2타일 내의 안개를 제거합니다.<br><br>건물은 자원을 소모하여 새로운 자원을 생산합니다. 그들은 <b>자동으로</b> 필요한 자원을 수송할것입니다. 생산된 자원은 건물에 저장되며, 그 자원을 필요로 하는 다른 건물로 운반됩니다. 단, 건물의 저장공간은 한계가 있습니다.<br><br>건물은 운송과 노동에 <b>일꾼</b> 가 필요합니다. - 당신은 <b>오두막</b> 과 같은 주거용 건물을 건설하여 일꾼 인구를 늘릴수 있습니다. 건물을 업그레이드하면 생산량과 저장량이 늘어납니다..",
   Tutorial5:
      "<b>과학</b> 은 연구화면에서 새로운 기술을 잠금해제하는데 사용됩니다. 새 기술은 새로운 건물 및 불가사의를 잠금해제하거나, 다른 건물에 보너스를 적용합니다.<br><br><b>노동중인 일꾼</b>은 소량의 과학을 생산합니다. 이후에 학교나 도서관같은 건물을 잠금해제하여 과학을 생산할수도 있습니다.<br><br>사용 가능한 일꾼의 양은 <b>행복도</b>의 영향을 받습니다. 각 건물은 1의 행복도 비용이 필요합니다. 행복도는 기술, 불가사의, 위인들로부터 얻을수 있습니다. 일꾼들이 행복하지 않으면, 제국의 생산이 중단될수 있습니다.<br><br><b>불가사의</b>는 건물의 한 종류입니다 - 한개씩만 건설할수 있으며, 한번 건설한 뒤에 제거할수 없습니다. 불가사의는 상당한 양의 보너스를 제공하거나 새로운 메커니즘을 해제할수 있습니다.",
   Tutorial6:
   ...
   UNGeneralAssemblyMultipliers: "<b>%{buildings}</b>에 대한 생산, 일꾼 수용력 및 저장 배수 <b>+%{count}</b> ",
   ...
   UnitedNations: "연합 국가",
   UnitedNationsDesc: "모든 티어 IV, V, VI 건물은 +1 생산, 일꾼 수용력, 저장 배수를 얻습니다. UN 총회에 참여하고 매주 추가 부스트에 투표하세요",
   ...
   Water: "물",
   WellStockedTooltip: "재고가 풍부한 건물은 생산을 위한 충분한 자원을 보유한 건물입니다. 여기에는 생산 중인 건물 또는 저장고가 꽉 차 있거나 일꾼 부족으로 인해 생산하지 않는 건물이 포함됩니다.",
   ...
   Wood: "나무",
   Worker: "일꾼",
   WorkerCapacityMultiplier: "일꾼 당 생산능력 배수",
   WorkerHappinessPercentage: "행복도 배수",
   WorkerMultiplier: "일꾼 당 생산능력",
   WorkerPercentagePerHappiness: "행복도당 %{value}% 배수",
   Workers: "일꾼",
   WorkersAvailableAfterHappinessMultiplier: "행복도 배수 적용 후 일꾼 수",
   WorkersAvailableBeforeHappinessMultiplier: "행복도 배수 적용 전 일꾼 수",
   WorkersBusy: "노동중인 일꾼",
   WorkerScienceProduction: "일꾼 과학 생산",
   WorkersRequiredAfterMultiplier: "필요한 일꾼",
   WorkersRequiredBeforeMultiplier: "필요한 생산능력",
   WorkersRequiredForProductionMultiplier: "일꾼 당 생산능력",
   WorkersRequiredForTransportationMultiplier: "일꾼 당 운송용량",
   WorkersRequiredInput: "운송에 필요한 일꾼",
   WorkersRequiredOutput: "생산에 필요한 일꾼",
   WorldWarAge: "세계대전",
   WritersGuild: "작가 길드",
   Writing: "집필",
   WuZetian: "측천무후",
   ...
   Xuanzang: "현장",
   YangtzeRiver: "양쯔강",
   YangtzeRiverDesc: "물을 소비하는 모든 건물은 생산력, 일꾼 수용력, 저장소 배수를 +1 얻습니다. 정화(위인)의 효과가 두 배로 증가합니다. 영구적인 측천무후(위인)은 레벨 당 모든 건물에 +1 저장소 배수를 제공합니다.",
