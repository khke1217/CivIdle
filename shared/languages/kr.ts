export const KR = {
   ...
   AngkorWat: "앙코르 와트",
   AngkorWatDesc: "모든 인접한 건물이 +1의 노동력 배수를 얻습니다. 1000명의 노동자를 생산합니다.",
   ...
   ApolloProgramDesc: "모든 로켓 공장은 생산, 노동력, 저장 배수 +2를 얻습니다. 위성 공장, 우주선 공장, 핵 미사일 사일로는 인접한 로켓 공장마다 생산 배수 +1을 얻습니다.",
   ApplyToAll: "일괄 적용",
   ...
   BrandenburgGateDesc: "모든 석탄광산과 유정이 +1의 생산, 저장소, 노동력 배수를 얻습니다. 정유 공장이 인접한 석유 타일 하나당 +1의 생산, 저장소, 노동자 당 생산량 배수를 얻습니다.",
   Bread: "빵",
   Brewery: "양조장",
   Brick: "벽돌",
   Brickworks: "벽돌 공장",
   ...
   BuildingName: "이름",
   BuildingNoMultiplier: "%{building}은 생산, 노동력, 저장 등의 배수에 <b>영향을 받지 않습니다</b>.",
   ...
   ChichenItza: "치첸 이트사",
   ChichenItzaDesc: "모든 인접한 건물이 +1의 생산, 저장소, 노동력 배수를 얻습니다.",
   ...
   CNTower: "CN 타워",
   CNTowerDesc: "모든 영화 스튜디오, 라디오 방송국 및 TV 방송국은 행복도 -1이 면제됩니다. 세계 대전과 냉전에서 잠금 해제된 모든 건물은 +N 생산, 노동력 및 저장 배수를 얻습니다. N = 건물의 티어와 시대의 차이",
   Coal: "석탄",
   CoalMine: "석탄 광산",
   ...
   Education: "교육",
   EiffelTower: "에펠탑",
   EiffelTowerDesc: "모든 인접한 제강공장이 +N 의 생산, 저장소, 노동력 배수를 얻습니다. N = 인접한 제강공장의 수",
   Electricity: "전력",
   Electrification: "전기화",
   ...
   ForbiddenCity: "자금성",
   ForbiddenCityDesc: "모든 제지소, 인쇄소, 작가 길드가 +1의 생산, 저장소, 노동력 배수를 얻습니다",
   Forex: "외환",
   ForexMarket: "외환 시장",
   ...
   GoldMiningCamp: "금 광산",
   GrandBazaar: "그랜드 바자르",
   GrandBazaarDesc: "모든 시장을 한곳에서 통제하세요! 모든 인접한 건물은 +5 저장 배수를 얻습니다.",
   ...
   GreatWall: "만리장성",
   GreatWallDesc: "1 타일 범위 내의 모든 건물은 +N 생산, 노동력 및 저장 배수를 얻습니다. N = 현재 시대와 건물이 처음 잠금 해제된 시대 사이의 시대 수입니다. 자금성 옆에 건설하면 범위가 2타일로 늘어납니다.",
   ...
   HangingGardenDesc: "+1 건축가 용량 배수. 인접한 수로가 +1의 생산, 저장소, 노동력 배수를 얻습니다.",
   Happiness: "행복도",
   ...
   Herodotus: "헤로도토스",
   HimejiCastle: "히메지 성",
   HimejiCastleDesc: "모든 캐러벨 조선소, 갤리온 조선소, 프리깃 조선소가 +1의 생산, 저장소, 노동력 배수를 얻습니다.",
   Hollywood: "할리우드",
   ...
   ManhattanProjectDesc: "모든 우라늄 광산이 +2 생산, 노동력, 저장소 배수를 얻습니다. 우라늄 농축 공장과 핵 물질 재처리시설은 우라늄 매장지 위에 건설된 인접한 우라늄 광산마다 +1 생산 배수를 얻습니다.",
   Marble: "대리석",
   Marbleworks: "대리석 공장",
   MarcoPolo: "마르코 폴로",
   MarieCurie: "마리 퀴리",
   ...
   MoaiDesc: "모아이 석상",
   MogaoCaves: "막고굴",
   MogaoCavesDescV2: "생산 효율이 100%인 건물 10개 당 행복도가 1 증가합니다. 인접한 모든 성소는 행복도 -1에서 면제됩니다.",
   ...
   Parliament: "국회",
   Parthenon: "파르테논 신전",
   ParthenonDescV2: "고전 시대의 위인 둘이 태어나고 각각 4개의 선택권을 얻습니다. 음악가 길드와 화가 길드가 +1 생산력, 노동력, 저장 배수를 얻고 행복도 -1이 면제됩니다.",
   PatchNotes: "패치노트",
   PermanentGreatPeople: "영구적인 위인",
   PermanentGreatPeopleAcquired: "영구적인 위인 획득",
   PermanentGreatPeopleLevels: "영구적인 위인 레벨",
   Persepolis: "페르세폴리스",
   PersepolisDesc: "모든 벌목장, 채석장, 구리광산이 +1의 생산, 저장소, 노동력 배수를 얻습니다.",
   Petra: "페트라",
   ...
   RijksmuseumDesc: "행복도 +5, 문화를 소비하거나 생산하는 모든 건물이 +1의 생산, 저장소, 노동력 배수를 얻습니다.",
   RoadAndWheel: "도로와 바퀴",
   RobertNoyce: "로버트 노이스",
   Robotics: "로봇공학",
   Rocket: "로켓",
   ...
   SaintBasilsCathedralDescV2: "자원 추출 건물이 광산 근처에서 작동하도록 허용합니다. 모든 티어 1 건물은 생산량 배수, 노동력, 저장소 배수 +1을 얻습니다.",
   Saladin: "살라딘",
   Sand: "모래",
   Sandpit: "모래 채취장",
   ...
   StatueOfLibertyDesc: "모든 인접한 건물이 +N의 생산, 저장소, 노동력 배수를 얻습니다. N = 동일한 유형의 인접한 건물 수",
   StatueOfZeus: "제우스 상",
   ...
   SummerPalace: "이화원",
   SummerPalaceDesc: "화약을 생산하거나 소비하는 모든 인접한 건물은 행복도 -1이 면제되며, 화약을 소비하거나 생산하는 모든 건물이 +1의 생산, 저장소, 노동력 배수를 얻습니다.",
   Sword: "검",
   SwordForge: "검 대장간",
   ...
   TempleOfArtemisDesc: "완성 즉시 모든 검 대장간과 무기고가 +5레벨을 얻습니다. 모든 검 대장간과 무기고가 +1의 생산, 저장소, 노동력 배수를 얻습니다.",
   TempleOfHeaven: "천단",
   TempleOfHeavenDesc: "레벨 10이상의 모든 건물이 +1의 노동력 배수를 얻습니다.",
   TempleOfPtah: "프타 사원",
   TerracottaArmy: "병마용",
   ...
   UNGeneralAssemblyMultipliers: "<b>%{buildings}</b>에 대한 생산량, 노동력 및 저장소 배수 <b>+%{count}</b> ",
   ...
   UnitedNations: "연합 국가",
   UnitedNationsDesc: "모든 티어 IV, V, VI 건물은 +1 생산량, 노동력, 저장소 배수를 얻습니다. UN 총회에 참여하고 매주 추가 부스트에 투표하세요",
   ...
   Wood: "나무",
   Worker: "노동자",
   WorkerCapacityMultiplier: "노동력 배수",
   ...
   WorkersRequiredBeforeMultiplier: "필요한 노동력",
   ...
   Xuanzang: "현장",
   YangtzeRiver: "양쯔강",
   YangtzeRiverDesc: "물을 소비하는 모든 건물은 생산력, 노동력, 저장소 배수를 +1 얻습니다. 정화(위인)의 효과가 두 배로 증가합니다. 영구적인 측천무후(위인)은 레벨 당 모든 건물에 +1 저장소 배수를 제공합니다.",
   YellowCraneTower: "황학루",
   YellowCraneTowerDesc: "위인을 선택할 때 선택지 +1. 1 타일 범위 내의 모든 건물은 +1 생산, 노동력 및 저장소 배수를 얻습니다. 양쯔강 옆에 건설 시 범위가 2타일로 증가합니다.",
   Zenobia: "제노비아",
